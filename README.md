...
![create AudioBooks folder Shortcuts folder in Files](/createAudioBooksFolder.gif){:height="50%" width="50%"}
* можно создать папку для конкретной книги внутри неё - это удобно, если у книг много глав: главы разных книг не смешиваются

![create BookName folder in Shortcuts/AudioBooks](/createBookNameFolder.gif){:height="50%" width="50%"}
...
![download audiobook demonstration into Shortcuts/AudioBooks/BookName](/demonstration.gif){:height="50%" width="50%"}
