...
6. Сразу за чёрным названием папки (во вкладке "Обзор" - вкладку выбираем внизу) следует кнопка "Выбрать" (её немного видно, если файлов в папке много и чуть-чуть проскроллить) и за ней крайняя правая "Отменить". 
...
8. Нажать "Открыть" (на месте кнопки "Выбрать" сразу за словом "Выбор").
